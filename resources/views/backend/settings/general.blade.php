                        ...
                        <div class="col ">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <input type="hidden" name="font_color" id="font_color" value="color-2">
                                    <input type="color" name="start_color" id="start_color" value="#333">
                                    <input type="color" name="end_color" id="end_color" value="#dee">
                    ...
                    <div class="row mt-4 mb-4">
                        <div class="col">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="row form-group">
                                        {{ html()->label(__('labels.backend.logo.slide_image'))->class('col-md-2 form-control-label')->for('slider_logo') }}
        
                                        <div class="col-md-10">
                                            {!! Form::file('slider_logo', ['class' => 'form-control d-inline-block', 'placeholder' => '', 'data-preview'=>'#slider_logo_preview', 'accept' => 'image/jpeg,image/gif,image/png']) !!}
                                            <p class="help-text mb-0 font-italic">{!!  __('labels.backend.logo.slide_imageـnote')!!}</p>
                                        </div>
                                        <div class="col-md-8 offset-md-2">
                                            <div id="slider_logo_preview" class="d-inline-block p-3 preview">
                                                <img height="50px" src="{{asset('storage/logos/'.config('slider_logo'))}}">
                                            </div>
                                        </div>
                                    </div>                                
                        </div>
    ...
    <script>
        $(document).ready(function () {
           ...
           // $('#font_color').val("{{config('font_color')}}");
            $('#start_color').val("{{config('start_color')}}");
            $('#end_color').val("{{config('end_color')}}");
            @endif
